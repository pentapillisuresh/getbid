              ...
              <div className="flex items-start justify-between mb-4">
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <span
                      className={`px-3 py-1 rounded-md text-sm font-medium ${tender.statusColor}`}
                    >
                      {tender.status}
                    </span>
                  </div>
                  ...
                  <div className="flex items-center gap-4 mb-4">
                    <div className="flex items-center gap-2">
                      <span
                        className={`w-3 h-3 rounded-full ${
                          tender.technicalStatus === "completed"
                            ? "bg-green-500"
                            : tender.technicalStatus === "in-progress"
                            ? "bg-orange-500"
                            : "bg-gray-300"
                        }`}
                      ></span>
                    ...
                    <div className="flex items-center gap-2">
                      <span
                        className={`w-3 h-3 rounded-full ${
                          tender.financialStatus === "completed"
                            ? "bg-green-500"
                            : tender.financialStatus === "in-progress"
                            ? "bg-orange-500"
                            : "bg-gray-300"
                        }`}
                      ></span>
                ...
                <div className="flex flex-col gap-2 ml-4">
                  <button
                    onClick={() => {
                      if (
                        tender.title === "Highway Construction Project Phase 2"
                      ) {
