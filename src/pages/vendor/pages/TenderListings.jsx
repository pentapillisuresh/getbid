    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto p-6 space-y-6">
        ...
        <div className="space-y-6">
          {loading && <div className="text-center py-8">Loading tenders...</div>}
                ...
                <div className="p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                    <div className="bg-green-50 p-4 rounded-lg">
                      ...
                      <div className="font-bold text-green-700 text-xl">{t.estimatedValue}</div>
                    </div>
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                    <div className="flex flex-wrap items-center gap-4">
                      <button onClick={() => openPopup('details', t)} className="flex items-center gap-2 text-blue-600 hover:text-blue-700 font-medium">
                        <Eye className="w-4 h-4" /> View Details
                      </button>
                      <button onClick={() => openPopup('qa', t)} className="flex items-center gap-2 text-purple-600 hover:text-purple-700 font-medium">
                      ...
                      <button onClick={() => openPopup('support')} className="flex items-center gap-2 text-orange-600 hover:text-orange-700 font-medium">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button onClick={() => openPopup('submit', t)} className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg font-medium transition-transform hover:scale-105">Submit Bid</button>
                    </div>
                  </div>
                </div>
              </div>
