...
const ParticipantsList = ({ tender, onClose }) => {
  ...
  const qualifiedParticipants = participants.filter(p => p.status === 'Accepted');
      ...
      <div className="bg-white rounded-xl max-w-6xl w-full max-h-[90vh] overflow-auto m-4">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div>
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-2xl font-bold text-gray-900">Participants List</h2>
            </div>
        ...
        <div className="mx-6 mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="font-medium text-blue-900 mb-1">Visibility Information</h3>
              <p className="text-sm text-blue-700">
                Only qualified participants and accepted bids are shown with full details. Rejected bids have limited information visibility for confidentiality.
              </p>
            </div>
          </div>
        </div>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-200">
                  ...
                  <th className="text-left py-3 px-4 font-medium text-gray-700">BID VALUE</th>
              ...
              <tbody>
                {qualifiedParticipants.map((participant, index) => (
                  <tr key={index} className="border-b border-gray-100 hover:bg-gray-50">
                      ...
                      <div className="flex items-center gap-3">
                        <div className="w-8 h-8 bg-gray-200 rounded-full flex items-center justify-center">
                          <span className="text-sm font-medium text-gray-600">
                            {participant.vendorName.split(' ').map(word => word[0]).join('').slice(0, 2)}
                          </span>
                        </div>
                        <div>
                    ...
                    <td className="py-4 px-4">
                      <span className="font-semibold text-green-600">{participant.bidValue}</span>
                    </td>
                    <td className="py-4 px-4">
                      <span className="text-gray-700">{participant.experience}</span>
                    </td>
                    <td className="py-4 px-4">
                    ...
                    <td className="py-4 px-4">
                      <div className="flex items-center gap-2">
                        <span className="text-gray-700">{participant.documents} files</span>
        ...
        <div className="mx-6 mb-6">
          <h3 className="font-medium text-gray-900 mb-3">Rejected Participants</h3>
          <div className="bg-gray-50 rounded-lg p-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <span className="font-medium text-gray-700">Perfect Clean Ltd.</span>
