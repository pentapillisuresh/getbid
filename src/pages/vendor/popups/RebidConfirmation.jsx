...
import { X, TriangleAlert as AlertTriangle, RotateCcw, Clock, Info } from 'lucide-react';
      ...
      <div className="bg-white rounded-xl max-w-lg w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-5 border-b border-gray-200">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-bold text-gray-900">Confirm Re-Bid</h2>
        ...
        <div className="p-5 space-y-4">
          ...
          <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
            ...
            <div className="space-y-1 text-sm">
              <div className="flex justify-between">
                ...
                <span className="font-medium text-orange-900 text-right flex-1 ml-2">{tender.title}</span>
              </div>
              <div className="flex justify-between">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
            <div className="flex items-center gap-2">
              ...
              <div>
                <span className="font-medium text-yellow-900 text-sm">Deadline: 15d 6h remaining</span>
                <p className="text-xs text-yellow-700 mt-1">Submit well before deadline</p>
              </div>
            </div>
          </div>
        </div>
