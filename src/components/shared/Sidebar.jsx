...
const Sidebar = ({ items, basePath, sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    <>
      {/* Desktop Sidebar */}
      <aside className="hidden lg:block w-64 bg-gray-300 border-r border-gray-300 fixed left-0 top-16 bottom-0 z-20">
      ...
      {/* Mobile Sidebar */}
      <aside className={`lg:hidden fixed left-0 top-0 bottom-0 w-64 bg-gray-100 border-r border-gray-300 z-50 transform transition-transform duration-300 ${
