          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 text-lg mb-8 leading-relaxed">
                Secure, organized, and accessible document management for all
                your tendering needs. Store, share, and collaborate on tender
          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 text-lg max-w-3xl mx-auto">
                Streamline your document workflows with powerful organization,
                security, and collaboration features designed for tendering
                professionals.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-8 rounded-xl">
                ...
                <p className="text-gray-700 leading-relaxed">
                  Automatically categorize and organize documents by tender,
                  project, or client with powerful search capabilities.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-8 rounded-xl">
                ...
                <p className="text-gray-700 leading-relaxed">
                  Bank-level encryption, secure controls, and audit trails
                  ensure your sensitive documents are protected at all times.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-green-50 to-green-100 p-8 rounded-xl">
                ...
                <p className="text-gray-700 leading-relaxed">
                  Track document changes, maintain version history, and prevent
                  conflicts with advanced version control and change tracking.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-orange-50 to-orange-100 p-8 rounded-xl">
                ...
                <p className="text-gray-700 leading-relaxed">
                  Share documents securely with team members, partners, or
                  clients with granular access controls and permissions.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-red-50 to-red-100 p-8 rounded-xl">
                ...
                <p className="text-gray-700 leading-relaxed">
                  Work together on documents in real-time with collaborative
                  editing, comments, and team insights throughout the bidding
                  process.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-cyan-50 to-cyan-100 p-8 rounded-xl">
                ...
                <p className="text-gray-700 leading-relaxed">
                  Access your documents from anywhere with secure cloud storage,
                  automatic backups, and unlimited scalability.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 bg-gradient-to-br from-purple-50 to-blue-50">
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 text-lg max-w-3xl mx-auto">
                Our system handles every type of document you need for
            ...
            <div className="grid md:grid-cols-4 gap-6">
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  RFPs, RFQs, bid documents, addenda, and all official tender
                  documentation.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Technical proposals, pricing documents, and supporting
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Insurance policies, compliance documents, and qualification
                  proofs.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Balance sheets, financial statements, and other financial
                  documentation.
                </p>
              </div>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-gray-600 text-lg mb-8 leading-relaxed">
                  Your sensitive tender documents deserve the highest level of
                  protection. Our security measures ensure complete
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        Granular permissions ensure only authorized personnel
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        Track every action, download, and edit with
                        comprehensive audit logs of who accessed, modified, or
                        shared documents.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        Meet all industry and regulatory compliance requirements
        ...
        <section className="py-16 bg-gradient-to-br from-purple-50 to-indigo-50">
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 text-lg max-w-3xl mx-auto">
                From upload to approval, our workflow ensures efficient document
                management throughout your tendering process.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-4 gap-6">
              <div className="text-center">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Drag and drop documents in bulk, upload with automatic
                  categorization, and smart tagging.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Team members can review, comment, and collaborate on documents
                  in real-time with integrated editing tools.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Structured approval workflows ensure documents are reviewed
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Securely share approved documents with stakeholders or submit
                  directly to tendering portals.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 text-lg max-w-3xl mx-auto">
                Connect with your existing tools and government portals for a
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-8 rounded-xl text-center">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Direct integration with major government tendering portals for
                  seamless document submission and status updates.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-green-50 to-green-100 p-8 rounded-xl text-center">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Native integration with Microsoft Office, Google Workspace,
                  and other productivity tools for seamless editing.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-8 rounded-xl text-center">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Integrate with email systems and communications tools for
                  automated notifications and document sharing.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="bg-gradient-to-r from-purple-600 to-indigo-600 py-16">
          <div className="max-w-4xl mx-auto px-4 text-center">
            ...
            <p className="text-purple-100 text-lg mb-8 leading-relaxed">
              Join thousands of businesses who trust our platform to manage
              their critical tender documents securely and efficiently.
            </p>
