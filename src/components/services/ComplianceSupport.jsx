          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 text-lg mb-8 leading-relaxed">
                Navigate complex government regulations with confidence. Our
                compliance experts ensure your bids meet all requirements and
                regulatory standards for successful tender submissions.
              </p>
          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 text-lg max-w-3xl mx-auto">
                Stay compliant with ever-changing government regulations and
                tender requirements with our expert guidance and automated
                compliance tools.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-gradient-to-br from-orange-50 to-orange-100 p-8 rounded-xl">
                ...
                <p className="text-gray-700 leading-relaxed">
                  Stay updated with latest government regulations, compliance
                  standards, and requirements across all departments and
                  jurisdictions.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-8 rounded-xl">
                ...
                <p className="text-gray-700 leading-relaxed">
                  Automated verification of all required documents, licenses,
                  and supporting materials before bid submission to prevent
                  rejections.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-green-50 to-green-100 p-8 rounded-xl">
                ...
                <p className="text-gray-700 leading-relaxed">
                  Track and manage all business certifications, licenses,
                  insurance policies, and renewal reminders and compliance
                  deadlines.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-8 rounded-xl">
                ...
                <p className="text-gray-700 leading-relaxed">
                  Regular compliance audits and assessments to identify
                  potential issues and ensure adherence to regulatory
                  requirements.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-red-50 to-red-100 p-8 rounded-xl">
                ...
                <p className="text-gray-700 leading-relaxed">
                  Comprehensive risk and obligation analysis to identify
                  compliance risks and protect your business interests.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-teal-50 to-teal-100 p-8 rounded-xl">
                ...
                <p className="text-gray-700 leading-relaxed">
                  Access to compliance experts and legal professionals for
                  complex tender queries and specialized guidance.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 bg-gradient-to-br from-orange-50 to-red-50">
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 text-lg max-w-3xl mx-auto">
                We cover all critical compliance areas to ensure your business
                meets government tendering requirements.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-4 gap-6">
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Company registration, tax identification, and legal business
                  registrations.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Financial reporting, insurance coverage, and government
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  ISO certifications, quality management, and industry-specific
                  standards.
                </p>
              </div>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 text-lg max-w-3xl mx-auto">
                A systematic approach to ensure complete compliance with all
                government tendering requirements.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-4 gap-6">
              <div className="text-center">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Comprehensive review of your current compliance status and
                  identification of gaps or requirements.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Develop a detailed action plan with timelines and priorities
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Execute compliance measures with expert guidance and support
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Ongoing monitoring and maintenance to ensure continued
              ...
              <div className="space-y-6">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Ensure your bids are never rejected due to compliance
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Minimize potential legal issues with our compliance and
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Stand out from competitors with superior compliance
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Streamlined approval processes with complete and accurate
        ...
        <section className="py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 text-lg max-w-3xl mx-auto">
                Work with experienced professionals who understand government
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-gradient-to-br from-orange-50 to-orange-100 p-8 rounded-xl text-center">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Qualified legal professionals with deep expertise in
                  government contract compliance law.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-8 rounded-xl text-center">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Sector-specific experts who understand the unique compliance
              ...
              <div className="bg-gradient-to-br from-green-50 to-green-100 p-8 rounded-xl text-center">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Personal consultants assigned to provide ongoing support and
                  answer your compliance guidance.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="bg-gradient-to-r from-orange-600 to-red-600 py-16">
          <div className="max-w-4xl mx-auto px-4 text-center">
            ...
            <p className="text-orange-100 text-lg mb-8 leading-relaxed">
              Don't let compliance issues prevent you from winning government
              contracts. Get expert help to ensure your business meets all
              requirements.
            </p>
