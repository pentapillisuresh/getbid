          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 text-lg mb-8 leading-relaxed">
                Transform your tendering performance with powerful analytics and
                comprehensive reporting. Make data-driven decisions to improve
                your success rate and optimize your bidding strategy.
              </p>
          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 text-lg max-w-3xl mx-auto">
                Gain deep insights into your tendering performance with
                comprehensive analytics and intelligent reporting tools.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-gradient-to-br from-cyan-50 to-cyan-100 p-8 rounded-xl">
                ...
                <p className="text-gray-700 leading-relaxed">
                  Track key performance indicators including win rates, bid
                  success ratios, and revenue generated from government
                  contracts.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-8 rounded-xl">
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  tender trends, and opportunity identification across sectors.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-8 rounded-xl">
                ...
                <p className="text-gray-700 leading-relaxed">
                  Identify emerging trends in government spending, tender
                  patterns, and market opportunities to stay ahead of your
                  competition.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-green-50 to-green-100 p-8 rounded-xl">
                ...
                <p className="text-gray-700 leading-relaxed">
                  Create personalized dashboards with the metrics that matter
                  most to your business and decision-making process.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-orange-50 to-orange-100 p-8 rounded-xl">
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  templates for stakeholders and management reviews.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-red-50 to-red-100 p-8 rounded-xl">
                ...
                <p className="text-gray-700 leading-relaxed">
                  Use AI-powered predictions to forecast tender outcomes,
                  identify high-probability opportunities, and optimize resource
                  allocation.
                </p>
              </div>
            </div>
        ...
        <section className="py-16 bg-gradient-to-br from-cyan-50 to-blue-50">
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 text-lg max-w-3xl mx-auto">
                Get a complete view of your tendering performance with our
            ...
            <div className="grid md:grid-cols-4 gap-6">
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Track your success rate across different tender categories and
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Monitor contract values, revenue growth, and financial
                  performance from government tenders.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Analyze bid preparation times, submission patterns, and
                  deadline management efficiency.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Evaluate team productivity, workload distribution, and
              ...
              <div className="space-y-6">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Transform raw data into actionable insights that drive
                      better bidding strategies and improved success rates.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Spot emerging market trends and high-value opportunities
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Continuously improve your processes based on performance
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Generate professional reports for stakeholders with key
        ...
        <section className="bg-gradient-to-r from-teal-600 to-cyan-600 py-16">
          <div className="max-w-4xl mx-auto px-4 text-center">
            ...
            <p className="text-teal-100 text-lg mb-8 leading-relaxed">
              Unlock the power of analytics to transform your tendering
